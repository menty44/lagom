package org.blaqueyard.hello.impl;
...
import org.blaqueyard.hello.api.GreetingMessage;
import org.blaqueyard.hello.api.HelloService;
import org.blaqueyard.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<org.blaqueyard.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      org.blaqueyard.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new org.blaqueyard.hello.api.HelloEvent.GreetingMessageChanged(
